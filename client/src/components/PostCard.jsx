    ...
    className="w-full border-b border-[#66666645]">
      ...
      {errMsg?.message && (
            ...
            <div className="flex items-end justify-end pb-2">
              ...
              <CustomButton
                type="submit"
                containerStyles={`px-3 py-1 text-sm font-semibold text-white bg-[#0444a4] rounded-full`}
                title="submit"
              />
            )}
            </div>
  ...
  return(
    <div className="w-full py-3">
      <div className="flex gap-3 items-center mb-1 ">
        ...
        {moment(reply?.createdAt ).fromNow()}</span>
        </div>
              ...
              comments?.length > 0 ? (
               comments?.map((comment) => (
                 ...
                 <div className="flex gap-3 items-center mb-1">
                  ...
                  <span className="text-ascent-2 text-sm">
                    {moment(comment?.createdAt ?? "2023-05-25").fromNow()}</span>
                  </div>
                 </div>
                 <div className="ml-12">
                  <p className="text-ascent-2">
                 ...
                 <div className="py-2 px-8 mt-6"> 
                  {comment?.replies?.length > 0 && (
                    ...
                    onClick={() => 
                      setShowReply( 
                        showReply === comment?.replies?._id ? 0
                        :comment?.replies?._id
                      )}>
                 ...
                 </div>
                  {
                    showReply === comment?.replies?._id && (
                      comment?.replies?.map((reply) => (
                        ...
                        handleLike={()=>handleLike("/posts/like-comment/" +comment?.id + "/" +reply?._id)} />
